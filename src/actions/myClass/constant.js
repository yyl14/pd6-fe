...
export const gradeConstants = {
  ...
  FETCH_GRADE_TEMPLATE_START: 'FETCH_GRADE_TEMPLATE_START',
  FETCH_GRADE_TEMPLATE_SUCCESS: 'FETCH_GRADE_TEMPLATE_SUCCESS',
  FETCH_GRADE_TEMPLATE_FAIL: 'FETCH_GRADE_TEMPLATE_FAIL',
