...
import { fetchCourse, fetchClass, fetchChallenge, browseSubmitLang } from '../../../actions/common/common';
        ...
        sampleDataIds
          ...
          .map((id) => ({
            ...
            time: judgeCases.byId[`${submissions[submissionId]?.latestJudgmentId}-${id}`]
              ...
              : '',
            memory: judgeCases.byId[`${submissions[submissionId]?.latestJudgmentId}-${id}`]?.peak_memory,
            status: judgeCases.byId[`${submissions[submissionId]?.latestJudgmentId}-${id}`]?.verdict,
            score: judgeCases.byId[`${submissions[submissionId]?.latestJudgmentId}-${id}`]?.score,
          }))
          .sort((a, b) => {
