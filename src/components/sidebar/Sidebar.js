...
import Challenge from './config/Challenge';
import Course from './config/Course';
import Empty from './config/Empty';
import Grade from './config/Grade';
import MyClass from './config/MyClass';
import MyProfile from './config/MyProfile';
import PeerReview from './config/PeerReview';
import ProblemSet from './config/ProblemSet';
import ProblemSetChallenge from './config/ProblemSetChallenge';
